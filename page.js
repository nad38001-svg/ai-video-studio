  ...
  return (
    <main className="page">
      <div className="card">
        ...
        <p className="sub">Video + graphics + AI audio in one generation.</p>
        ...
        {video && (
          <section className="result">
            ...
            <a href={video} target="_blank" rel="noreferrer">Open / save video</a>
          </section>
        )}

        <p className="note">
          API usage can cost money. Keep your API key on the server and never paste it into browser code.
        </p>
      </div>
    </main>
  );
